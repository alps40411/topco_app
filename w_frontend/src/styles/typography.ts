...
export const TypographyClasses = {
  ...
  // 富文本
  richTextDisplay: `${TypographyStandards.richText.display} text-gray-700 leading-relaxed prose prose-sm max-w-none break-words overflow-hidden whitespace-pre-wrap`,
} as const;
